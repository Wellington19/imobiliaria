...
return [
    ...
    'service_manager' => [
        ...
        'factories' => [
            ...
            'CorretorTable' => 'Cadastros\\Model\\CorretorTableFactory',
            'ImovelTable' => 'Cadastros\\Model\\ImovelTableFactory',
        ...
        'routes' => [
            'cadastros' => [
                ...
                'options' => [
                    ...
                    'defaults' => [
                        'controller' => 'Cadastros\\Controller\\IndexController',
                        'action' => 'index'
                    ]
                ]
            ],
    ...
    'controllers' => [
        'aliases' => [
            'corretor' => 'Cadastros\\Controller\\CorretorController',
            'imovel' => 'Cadastros\\Controller\\ImovelController'
        ],
        'factories' => [
            'Cadastros\\Controller\\IndexController' => 'Laminas\\ServiceManager\\Factory\\InvokableFactory',
            'Cadastros\\Controller\\CorretorController' => 'Cadastros\\Controller\\CorretorControllerFactory',
            'Cadastros\\Controller\\ImovelController' => 'Cadastros\\Controller\\ImovelControllerFactory',
    ...
    'view_manager' => [
        ...
        'template_map' => [
            'cadastros/corretor/index' => 'D:\\Cursos\\PosGraduacao\\9-Laminas MVC\\imobiliaria\\module\\Cadastros\\config/../view/cadastros/corretor/index.phtml',
            'cadastros/imovel/index' => 'D:\\Cursos\\PosGraduacao\\9-Laminas MVC\\imobiliaria\\module\\Cadastros\\config/../view/cadastros/imovel/index.phtml',
            'error/404' => 'D:\\Cursos\\PosGraduacao\\9-Laminas MVC\\imobiliaria\\module\\Application\\config/../view/error/404.phtml',
            'error/index' => 'D:\\Cursos\\PosGraduacao\\9-Laminas MVC\\imobiliaria\\module\\Application\\config/../view/error/index.phtml',
            'layout/layout' => 'D:\\Cursos\\PosGraduacao\\9-Laminas MVC\\imobiliaria\\module\\Application\\config/../view/layout/layout.phtml',
            'application/index/index' => 'D:\\Cursos\\PosGraduacao\\9-Laminas MVC\\imobiliaria\\module\\Application\\config/../view/application/index/index.phtml'
        ],
        'template_path_stack' => [
            'D:\\Cursos\\PosGraduacao\\9-Laminas MVC\\imobiliaria\\module\\Cadastros\\config/../view',
            'D:\\Cursos\\PosGraduacao\\9-Laminas MVC\\imobiliaria\\module\\Application\\config/../view'
        ]
    ],
    'db' => [
        'driver' => 'Pdo_Mysql',
